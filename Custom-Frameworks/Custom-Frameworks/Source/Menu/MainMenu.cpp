...
void MainMenu::State::Init() {
	...
	animationSS->setRectButtonText("ANIMATION SHOWCASE", exAssets->getPrimaryFont(), sf::Color::Black);
	...
	golSS->setRectButtonText("GAMEOFLIFE SHOWCASE", exAssets->getPrimaryFont(), sf::Color::Black);
	...
	exitBtn->setRectButtonText("EXIT APPLICATION", exAssets->getPrimaryFont(), sf::Color::Black);
}
